...
export async function authenticate() {
  ...
  return await _fetch(`/passkeys/auth/signinResponse`, credential);
};

export async function updateCredential(credId, newName) {
  return _fetch(`/passkeys/auth/renameKey`, { credId, newName });
}

export async function unregisterCredential(credId) {
  return _fetch(`/passkeys/auth/removeKey?credId=${encodeURIComponent(credId)}`);
};
...
async function registerUserWithPasskey(username, displayName, password) {
  ...
  const options = await _fetch('/passkeys/auth/registerUserWithPasskey', {
    method: 'POST',
  ...
  return await _fetch('/passkeys/auth/registerResponse', {
    method: 'POST',
