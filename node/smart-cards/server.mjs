...
const options = {
    key: fs.readFileSync('/etc/letsencrypt/live/smart-cards.hasenhuettl.cc/privkey.pem'),
    cert: fs.readFileSync('/etc/letsencrypt/live/smart-cards.hasenhuettl.cc/fullchain.pem')
};
